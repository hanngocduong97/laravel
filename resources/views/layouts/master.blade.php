				...
				<div class="container">
					<div class="row">
						<div class="col-sm-4 col-md-4 col-lg-6 col-xl-7">
							<!-- logo start --> 
							<a href="{{asset('')}}"><img class="logo replace-2x img-responsive" src="{{ asset('shop_asset/images/logo.png')}}" alt=""/> </a> 
							<!-- logo end --> 
						</div>
									...
									<div class="cart link-inline">
										<div class="dropdown text-right">
											<a class="dropdown-toggle">
												<a href="{{asset('')}}cart"><span class="icon icon-shopping_basket"></span></a>
										...
										<!-- 	<div class="dropdown-menu dropdown-menu--xs-full slide-from-top" role="menu">
												<div class="container">
													...
													<ul>
														...
														<li class="cart__item">
															<div class="cart__item__image pull-left"><a href="#"><img src="{{asset('shop_asset/images/product/product-2.jpg') }}" alt=""/></a></div>
