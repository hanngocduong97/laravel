									...
									<div class="product__inside">
										...
										<div class="product__inside__image">
											...
											<div class="product__inside__carousel slide" data-ride="carousel">
												<div class="carousel-inner" role="listbox">
													<div class="item active" postID={{$postproduct->id}}> <a href="product.html"><img style=" height: 330px;" src="{{asset('') }}/storage/{{$postproduct->link}}" alt=""></a> </div>
													<div class="item" postID={{$postproduct->id}}> <a href="product.html"><img style=" height: 330px;"  src="{{asset('') }}/storage/{{$postproduct->link}}" alt=""></a> </div>
											...
											<!-- /product image carousel -->  
											<!-- quick-view --> 
											<a href="{{asset('')}}detail/{{$postproduct->id}}" postID={{$postproduct->id}} data-toggle="modal"  class="quick-view"><b><span class="icon icon-visibility"></span> Quick view</b> </a> 
											<!-- /quick-view --> 
											<!-- countdown_box -->
										...
										<div class="product__inside__hover">
											...
											<div class="product__inside__info">
												<!-- Màu ơ đây -->
											<!--  -->
												<div class="product__inside__info__btns"> <a href="{{asset('')}}cart/{{$postproduct->id}}" class="btn btn--ys btn--xl"><span class="icon icon-shopping_basket"></span> Add to cart</a>
